...
int main(int argc, char **argv)
{
    ...
    for (unsigned int i = 0; i < num_qps; i++) {
        ...
        // max_qp_rd_atom: max # of incoming RDMA READ and Atomic operations
        // that can be sent to a QP as the target of the operation
        connections[i].max_dest_rd_atomic = device.dev_attr.max_qp_rd_atom;
